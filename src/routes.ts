...
| { method: 'put', path: `/streams/${string}/mods/${string}`, parts: 4, params: undefined, response: undefined }
| { method: 'put', path: '-/streams/{stream_id}/mods/{user_id}', parts: 4, params: undefined, response: undefined }
| { method: 'delete', path: `/streams/${string}/mods/${string}`, parts: 4, params: undefined, response: undefined }
| { method: 'delete', path: '-/streams/{stream_id}/mods/{user_id}', parts: 4, params: undefined, response: undefined }
